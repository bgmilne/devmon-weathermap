...
%install
rm -Rf %{buildroot}
mkdir -p %{buildroot}/{%{_sysconfdir}/%{hobbit}/hobbitlaunch.d,%{_libdir}/%{hobbit}/server/ext,/var/lib/%{hobbit}/www/weathermap,%{_sysconfdir}/%{hobbit}/weathermap/images,%{_datadir}/%{hobbit}/www/help/}
...
install -m 644 images/*.png %{buildroot}/%{_sysconfdir}/%{hobbit}/weathermap/images
...
%{_sysconfdir}/%{hobbit}/weathermap/images
