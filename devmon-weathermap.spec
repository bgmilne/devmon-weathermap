...
%install
rm -Rf %{buildroot}
mkdir -p %{buildroot}/{%{_sysconfdir}/%{hobbit}/{hobbitlaunch.d,weathermap},%{_libdir}/%{hobbit}/server/ext,/var/lib/%{hobbit}/www/weathermap/images/{white,black},%{_datadir}/%{hobbit}/www/help/}

install -m 755 weathermap %{buildroot}/%{_libdir}/%{hobbit}/server/ext/
...
%dir %attr(-,xymon,xymon)/var/lib/%{hobbit}/www/weathermap
/var/lib/%{hobbit}/www/weathermap/images
%{_libdir}/%{hobbit}/server/ext/weathermap
